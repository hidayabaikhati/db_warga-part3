...
while($db_warga=mysqli_fetch_array($query)){
    ...
    echo"<td>".$db_warga['username']."</td>";
    echo"<td>".$db_warga['password']."</td>";
    echo"<td>".$db_warga['umur']."</td>";
...
<a href="tambah_daftar.php"><input type="submit" value="Tambah Data" name="tambah"/></a>
